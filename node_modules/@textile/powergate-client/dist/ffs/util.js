...
function coldObjToMessage(obj) {
    const cold = new rpc_pb_1.ColdConfig();
    cold.setEnabled(obj.enabled);
    if (obj.filecoin) {
        const fc = new rpc_pb_1.FilConfig();
        ...
        if (obj.filecoin.renew) {
            const renew = new rpc_pb_1.FilRenew();
